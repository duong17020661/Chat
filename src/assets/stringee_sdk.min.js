...
function StringeeHashMap() {
  ...
  return (
    ...
    (e.allValues = function () {
      for (var e = [], t = 0; t < this.length; t++) e.push(this[t].value);
      return e;
    }),
    e
  );
...
function StringeeClient() {
  ...
  setInterval(function () {
    if (0 != e.timeoutToReconnect && null != e.socket && !e.disconnectByUser) {
      Date.now() - e.lastTimeStampReceivedPacket > e.timeoutToReconnect &&
        (e.socket.disconnect(), e.socket.connect());
    }
  }, 1e4);
}
...
function StringeeChat(e) {
  this.client = e;
  var t = this;
  (this._onMethods = new StringeeHashMap()),
    (this.trackingMap = new StringeeHashMap()),
    (this.msgQueue = []),
    setInterval(function () {
      var e = Date.now();
      t.msgQueue = t.msgQueue.filter(function (t) {
        return t.expireTime > e;
      });
    }, 1e3),
    e.on("authensuccess", function (e) {
      t.sendMessageQueue();
    }),
    e.on("chatmessage", function (r) {
      var n = new StringeeMessage(r, 1),
        i = {
      ...
      e._sendMessage(StringeeServiceType.CHAT_MESSAGE_REPORT, i, function (
        e
      ) {}),
        t.trackMsg(n),
        t.fireObjectChangeEvent(ObjectType.MESSAGE, [n], ChangeType.INSERT),
        null != n.conversationId &&
          n.conversationId.length > 0 &&
          t.getConversationById(n.conversationId, function (e, r, n, i) {
            e &&
              null != i &&
              t.fireObjectChangeEvent(
    ...
    e.on("chatmessagestate", function (e) {
      var r = e.lastMsgSeq,
        n = e.status,
        i = (e.convId, t.trackingMap.allValues()),
        a = [];
      i.forEach(function (e) {
        if (r >= e.sequence)
          if (2 == n) {
            (e.state = MessageState.READ), a.push(e);
            var i = t.keyForMsg(e);
            t.trackingMap.remove(i);
          } else
            1 == n &&
              e.state != MessageState.READ &&
              e.state != MessageState.DELIVERED &&
              ((e.state = MessageState.DELIVERED), a.push(e));
      }),
        a.length > 0 &&
          t.fireObjectChangeEvent(ObjectType.MESSAGE, a, ChangeType.UPDATE);
    });
}
function StringeeConversation(e, t) {
  if (0 == t) {
    (this.id = e.convId),
      (this.name = e.lastMsg.content.groupName),
      (this.isGroup = e.isGroup),
      (this.updatedAt = e.lastUpdate),
      (this.unreadCount = 0),
      (this.creator = e.lastMsg.content.creator),
      (this.created = e.lastTimeNewMsg);
    var r = [],
      n = e.participants;
    n.forEach(function (e) {
      ...
      (this.participants = r),
      (this.lastMessage = new StringeeMessage(e, 3, 0, 0, t));
  } else if (1 == t) {
    (this.id = e.convId),
      (this.name = e.convName),
      (this.isGroup = e.isGroup),
      (this.updatedAt = e.lastUpdate),
      (this.unreadCount = e.unread),
    ...
    (this.id = e.convId),
      ...
      (this.isGroup = e.info.isGroup),
      (this.updatedAt = e.lastUpdate),
      (this.unreadCount = 0),
      (this.creator = e.info.creator),
      (this.created = e.info.created);
    var r = [],
      n = e.participants;
    n.forEach(function (e) {
      var t = new StringeeUser(e);
...
function StringeeMessage(e, t, r, n, i) {
  0 == t
    ? ((this.id = e.id),
      (this.localId = e.localDbId),
      (this.conversationId = e.convId),
      (this.sender = e.user),
      (this.createdAt = e.created),
      (this.sequence = e.seq),
      (this.type = e.type),
    ...
    : 3 == t &&
      (0 == i
        ? ((this.id = e.lastMsg.id),
          (this.localId = ""),
          (this.conversationId = e.convId),
          (this.sender = e.lastMsg.user),
          (this.createdAt = e.lastMsg.created),
          (this.sequence = 1),
          (this.type = e.lastMsg.type),
          (this.content = e.lastMsg.content),
          (this.state = MessageState.READ))
        : 1 == i
        ? ((this.id = null != e.lastMsgId ? e.lastMsgId : ""),
          (this.localId = ""),
          (this.conversationId = e.convId),
          (this.sender = e.lastMsgSender),
          (this.createdAt = e.lastTimeNewMsg),
          (this.sequence = e.lastMsgSeqReceived),
          (this.type = e.lastMsgType),
          (this.content = e.lastMsg),
          e.lastMsgSeqReceived > e.lastMsgSeqSeen
            ? (this.state = MessageState.DELIVERED)
            : (this.state = MessageState.READ))
        : 2 == i &&
          ((this.id = null != e.lastMsgId ? e.lastMsgId : ""),
          (this.localId = ""),
          (this.conversationId = e.convId),
          (this.sender = null != e.lastMsgSender ? e.lastMsgSender : ""),
          (this.createdAt = e.lastTimeNewMsg),
          (this.sequence = e.lastMsgSeqReceived),
          (this.type = e.lastMsgType),
          (this.content = e.lastMsg),
...
function StringeeUser(e) {
  (this.userId = e.user),
    (this.name = e.displayName),
    (this.email = e.email),
    (this.avatar = e.avatarUrl),
    null != e.lastMsgSeqReceived &&
      (this.lastMsgSeqReceived = e.lastMsgSeqReceived),
    null != e.lastMsgSeqSeen && (this.lastMsgSeqSeen = e.lastMsgSeqSeen);
}
function AutoMessage(e, t, r, n) {
  (this.id = e),
    (this.userId = t),
    (this.body = r),
    (this.callback = n),
      ...
      1: [
        function (e, t, r) {
          ...
          function i(e, t, r, n, i) {
            var a = l.writeRtpDescription(e.kind, t);
            if (
              ((a += l.writeIceParameters(e.iceGatherer.getLocalParameters())),
              (a += l.writeDtlsParameters(
            ...
            Object.defineProperty(f.prototype, "localDescription", {
                      ...
                      if (!(n.usingBundle && r > 0)) {
                        ...
                        if (s)
                          ...
                          "new" === i.state && (i.state = "gathering"),
                            (o.component = 1),
                            (o.ufrag = i.getLocalParameters().usernameFragment);
                          var c = l.writeCandidate(o);
                        ...
                        var d = l.getMediaSections(n._localDescription.sdp);
                        (d[a.candidate.sdpMLineIndex] += s
                          ? "a=end-of-candidates\r\n"
                          : "a=" + a.candidate.candidate + "\r\n"),
                          (n._localDescription.sdp =
                            l.getDescription(n._localDescription.sdp) +
                            d.join(""));
              ...
              (f.prototype.setLocalDescription = function (e) {
                ...
                if ("offer" === e.type)
                  ...
                  (r = l.splitSections(t._remoteDescription.sdp)),
                    (n = r.shift());
                  var i = l.matchPrefix(n, "a=ice-lite").length > 0;
                  r.forEach(function (e, r) {
                    var a = t.transceivers[r],
                      s = a.iceGatherer,
                      c = a.iceTransport,
                      d = a.dtlsTransport,
                      p = a.localCapabilities,
                      u = a.remoteCapabilities;
                    if (
                      !(
                        (l.isRejected(e) &&
                          0 === l.matchPrefix(e, "a=bundle-only").length) ||
                        a.rejected
                      )
                    ) {
              ...
              (f.prototype.setRemoteDescription = function (n) {
                ...
                var o = [],
                  f = l.splitSections(n.sdp),
                  h = f.shift(),
                  v = l.matchPrefix(h, "a=ice-lite").length > 0,
                  g = l.matchPrefix(h, "a=group:BUNDLE ").length > 0;
                i.usingBundle = g;
                var m = l.matchPrefix(h, "a=ice-options:")[0];
                return (
                  (i.canTrickleIceCandidates =
                    !!m && m.substr(14).split(" ").indexOf("trickle") >= 0),
                  f.forEach(function (s, d) {
                    var u = l.splitLines(s),
                      f = l.getKind(s),
                      m =
                        l.isRejected(s) &&
                        0 === l.matchPrefix(s, "a=bundle-only").length,
                      S = u[0].substr(2).split(" ")[2],
                      C = l.getDirection(s, h),
                      T = l.parseMsid(s),
                      y = l.getMid(s) || l.generateIdentifier();
                    if (
                      m ||
                      ("application" === f &&
                    ...
                    var _,
                      ...
                      w,
                      k,
                      D = l.parseRtpParameters(s);
                    m ||
                      ((w = l.getIceParameters(s, h)),
                      (k = l.getDtlsParameters(s, h)),
                      (k.role = "client")),
                      (M = l.parseRtpEncodingParameters(s));
                    var N = l.parseRtcpParameters(s),
                      L = l.matchPrefix(s, "a=end-of-candidates", h).length > 0,
                      x = l
                    ...
                    if (
                      ...
                      "answer" !== n.type ||
                        ...
                        (I = _.dtlsTransport),
                        (O = _.rtpReceiver),
                        (P = _.sendEncodingParameters),
                        (b = _.localCapabilities),
                        (i.transceivers[d].recvEncodingParameters = M),
                        (i.transceivers[d].remoteCapabilities = D),
                        (i.transceivers[d].rtcpParameters = N),
                        x.length &&
                          "new" === R.state &&
                          ((!v && !L) || (g && 0 !== d)
                        ...
                        (g && 0 !== d) ||
                          ("new" === R.state && R.start(E, w, "controlling"),
                          "new" === I.state && I.start(k)),
                        i._transceive(
                          _,
                          "sendrecv" === C || "recvonly" === C,
                          "sendrecv" === C || "sendonly" === C
                        ),
                        !O || ("sendrecv" !== C && "sendonly" !== C)
                          ? delete _.rtpReceiver
                          : ((A = O.track),
                            T
                              ? (a[T.stream] ||
                                  (a[T.stream] = new e.MediaStream()),
                                r(A, a[T.stream]),
                                o.push([A, O, a[T.stream]]))
                              : (a.default || (a.default = new e.MediaStream()),
                                r(A, a.default),
                                o.push([A, O, a.default]))));
                    else {
                      (_ = i.transceivers[d] || i._createTransceiver(f)),
                        (_.mid = y),
                        _.iceGatherer ||
                          (_.iceGatherer = i._createIceGatherer(d, g)),
                        x.length &&
                          ...
                          (!L || (g && 0 !== d)
                            ...
                            : _.iceTransport.setRemoteCandidates(x)),
                        (b = e.RTCRtpReceiver.getCapabilities(f)),
                        t < 15019 &&
                          (b.codecs = b.codecs.filter(function (e) {
                            return "rtx" !== e.name;
                          })),
                        (P = _.sendEncodingParameters || [
                          {
                          ...
                          (A = O.track),
                            (T && "-" === T.stream) ||
                              (T
                                ? (a[T.stream] ||
                                    ((a[T.stream] = new e.MediaStream()),
                                    Object.defineProperty(a[T.stream], "id", {
                                      get: function () {
                                        return T.stream;
                                      },
                                    })),
                                  ...
                                  (j = a[T.stream]))
                                : (a.default ||
                                    (a.default = new e.MediaStream()),
                                  (j = a.default))),
                            j &&
                              (r(A, j), _.associatedRemoteMediaStreams.push(j)),
                            o.push([A, O, j]);
                        }
                      } else
                        _.rtpReceiver &&
                      ...
                      (_.localCapabilities = b),
                        (_.remoteCapabilities = D),
                        (_.rtpReceiver = O),
                        (_.rtcpParameters = N),
                        (_.sendEncodingParameters = P),
                        (_.recvEncodingParameters = M),
                        i._transceive(i.transceivers[d], !1, U);
                    }
                  }),
                  void 0 === i._dtlsRole &&
              ...
              (f.prototype.createOffer = function () {
                ...
                var s = l.writeSessionBoilerplate(
                  r._sdpSessionId,
              ...
              (f.prototype.createAnswer = function () {
                ...
                var n = l.writeSessionBoilerplate(
                  r._sdpSessionId,
                  r._sdpSessionVersion++
                );
                r.usingBundle &&
                ...
                return e && void 0 === e.sdpMLineIndex && !e.sdpMid
                  ...
                  : new Promise(function (n, i) {
                      ...
                      if (e && "" !== e.candidate) {
                        ...
                        if (e.sdpMid)
                          for (var o = 0; o < r.transceivers.length; o++)
                            if (r.transceivers[o].mid === e.sdpMid) {
                              a = o;
                              break;
                            }
                        ...
                        if (
                          ...
                          return n();
                        if (p.component && 1 !== p.component) return n();
                        if (
                          (0 === a ||
                            (a > 0 &&
                              s.iceTransport !==
                        ...
                        0 === u.indexOf("a=") && (u = u.substr(2)),
                          (t = l.getMediaSections(r._remoteDescription.sdp)),
                          (t[a] +=
                            "a=" + (p.type ? u : "end-of-candidates") + "\r\n"),
                          (r._remoteDescription.sdp =
                            l.getDescription(r._remoteDescription.sdp) +
                            t.join(""));
                      } else for (var f = 0; f < r.transceivers.length && (r.transceivers[f].rejected || (r.transceivers[f].iceTransport.addRemoteCandidate({}), (t = l.getMediaSections(r._remoteDescription.sdp)), (t[f] += "a=end-of-candidates\r\n"), (r._remoteDescription.sdp = l.getDescription(r._remoteDescription.sdp) + t.join("")), !r.usingBundle)); f++);
                      n();
                    });
              }),
            ...
            switch (c.browser) {
              case "chrome":
                if (!d || !d.shimPeerConnection || !a.shimChrome)
                  return (
                    s("Chrome shim is not included in this adapter release."), h
                  );
                ...
                break;
              case "firefox":
                if (!p || !p.shimPeerConnection || !a.shimFirefox)
                  return (
                ...
                s("adapter.js shimming firefox."),
                  ...
                  p.shimSenderGetStats(i),
                  p.shimReceiverGetStats(i),
                  p.shimRTCDataChannel(i),
                  f.shimRTCIceCandidate(i),
                  f.shimMaxMessageSize(i),
                  f.shimSendThrowTypeError(i);
                break;
              ...
              case "safari":
                if (!u || !a.shimSafari)
                  return (
                    s("Safari shim is not included in this adapter release."), h
                  );
            ...
            return (
              ...
              o.forEach(function (t) {
                e.forEach(function (r) {
                  r.type === i && r.trackId === t.id && n(e, r, a);
                });
              }),
              a
            );
            ...
            if (
              ...
              if (
                ((r.mediaDevices.getUserMedia = function (e) {
                  return (
                    "object" == typeof e &&
                      "object" == typeof e.audio &&
                      ((e = JSON.parse(JSON.stringify(e))),
                      p(e.audio, "autoGainControl", "mozAutoGainControl"),
                      p(e.audio, "noiseSuppression", "mozNoiseSuppression")),
                    u(e)
                  );
                }),
                ...
                a.prototype.getSettings = function () {
                  ...
                  return (
                    p(e, "mozAutoGainControl", "autoGainControl"),
                    p(e, "mozNoiseSuppression", "noiseSuppression"),
                    e
                  );
                };
              }
                ...
                a.prototype.applyConstraints = function (e) {
                  return (
                    "audio" === this.kind &&
                      "object" == typeof e &&
                      ((e = JSON.parse(JSON.stringify(e))),
                      p(e, "autoGainControl", "mozAutoGainControl"),
                      p(e, "noiseSuppression", "mozNoiseSuppression")),
                    h.apply(this, [e])
                  );
                };
              }
...
(StringeeUtil.allClientsOfThisBrowser = []),
  ...
  (StringeeClient.prototype.connect = function (e) {
    ...
    (this.disconnectByUser = !1),
      ...
      (this.socket = io(t._stringeeServerAddr, {
        autoConnect: !1,
      })),
      this.socket.on("connect", function () {
        ...
        t._sendMessage(StringeeServiceType.AUTHEN, a, function (e) {
          0 === e.r
            ? ((t.hasConnected = !0),
              ...
              (t.userId = e.userId),
              (t.timeoutToReconnect = e.ping_after_ms + 15e3),
              t._callOnEvent("connect"),
              t._callOnEvent("authensuccess", e))
            : (t.hasConnected = !1),
  ...
  (StringeeClient.prototype._packetReceived = function (e, t) {
    ...
    e === StringeeServiceType.CALL_SDP_CANDIDATE_FROM_SERVER
      ...
      : e === StringeeServiceType.CHAT_USER_BEGIN_TYPING_NOTIFICATION
      ? StringeeChatProcessor._userBeginTypingListener(this, t)
      : e === StringeeServiceType.CHAT_USER_END_TYPING_NOTIFIACTION
      ? StringeeChatProcessor._userEndTypingListener(this, t)
      : e === StringeeServiceType.UPDATE_USER_INFO_NOTIFICATION
      ? StringeeChatProcessor._updateUserInfoMsg(this, t)
      : e === StringeeServiceType.SUBSCRIBE_FROM_SERVER
      ? this._callOnEvent("messagefromtopic", t)
      : e === StringeeServiceType.TIMEOUT_ROUTE_TO_QUEUE
      ? this._callOnEvent("timeoutInQueue", t)
      : e === StringeeServiceType.TIMEOUT_ROUTE_TO_AGENT
...
(StringeeCall.prototype.makeCall = function (e) {
  ...
  (StringeeCall.prototype.sendHold = function (e, t) {
    var r = this,
      n = {
        callId: this.callId,
        hold: !0,
    ...
    this.client._sendMessage(StringeeServiceType.HOLD, n, function (e) {
      return (
        t &&
          t.call(r, {
            r: e.r,
          }),
        0 == e.r && ((r.isOnHold = !0), !0)
      );
    });
  }),
  (StringeeCall.prototype.sendUnHold = function (e) {
    var t = this,
      r = {
        callId: this.callId,
        hold: !1,
      };
    this.client._sendMessage(StringeeServiceType.HOLD, r, function (r) {
      return (
        e &&
          e.call(t, {
            r: r.r,
          }),
        0 == r.r && ((t.isOnHold = !1), !0)
      );
    });
  }),
...
(StringeeProcessor._callSdpCandidateFromServer = function (e, t) {
  ...
  if ((n || (n = ""), "sdp" === t.type)) {
    var i = {
      ...
      a = new RTCSessionDescription(i);
    r._remoteSdps.put(n + "", a), r._pc && r._onRemoteSDP();
  } else if ("candidate" === t.type) {
    var o = new RTCIceCandidate(t.data),
  ...
  (StringeeCall.prototype._initPeerConnection = function (e, t, r) {
      ...
      try {
        ...
        (o.onicecandidate = function (e) {
          ...
          (o.oniceconnectionstatechange = function (e) {
            "connected" === o.iceConnectionState
              ? ((a._mediaConnected = !0),
                a._callOnEvent("mediastate", {
                  reason: "Connected",
                  code: 1,
                }))
              : "disconnected" === o.iceConnectionState &&
                a._callOnEvent("mediastate", {
                  reason: "Disconnected",
                  code: 2,
                });
          ...
          (a._pc = o),
          (a._localStream = n),
          a._callOnEvent("addlocalstream", a._localStream),
          e
            ? o.createOffer(function (e) {
                a._onCreateLocalSdpSuccess(e);
              }, a._onCreateLocalSdpError)
            : a._remoteSdps.size() > 0 && a._onRemoteSDP(),
          a.ended && (a._freeResource(), a.onRemove());
      } catch (e) {
        console.log(e), a._freeResource(), a.onRemove();
        var s = {
          callId: a.callId,
        };
        a.client._sendMessage(StringeeServiceType.CALL_STOP, s, function (
          e
        ) {}),
          a._callOnEvent("error", {
    ...
    function i(e) {
      t &&
        ...
        (r.moreInfo = e),
        t.call(a, r)),
        a._getUserMediaError(e);
    }
    var a = this,
      o = {
        audio: !0,
        video: a._buildVideoConstraints(!1),
      };
    navigator.mediaDevices.getUserMedia(o).then(n).catch(i);
  }),
  ...
  (StringeeCall.prototype.upgradeToVideoCall = function () {
    ...
    if (!r.isVideoCall) {
      var n = {
        audio: !1,
        video: r._buildVideoConstraints(!0),
      };
  ...
  (StringeeClient.prototype.sendChatOneToOneMsg = function () {});
const ObjectType = {
    CONVERSATION: 0,
    MESSAGE: 1,
  },
  ...
  realTimeEvent = "onObjectChange";
(StringeeChat.prototype.createConversation = function (e, t, r) {
  if (this.created)
    return void console.log(
      "Could not create conversation, conversation is created"
    );
  if (void 0 === e || null == e || null == e.length || 0 == e.length)
    return void r.call(this.client, !1, -2, "UserIds are invalid", null);
  ...
  var n;
  n = null == t.name || 0 == t.name.length ? "" : t.name;
  var i = {
    ...
    a = this;
  this.client._sendMessage(
    StringeeServiceType.CHAT_CREATE_CONVERSATION,
    i,
    function (e) {
      var t = e.r,
        n = 0 == t || 2 == t,
        i = n
          ...
          ? e.message
          : "Generic error.",
        o = n ? new StringeeConversation(e, t) : null,
        s = 0 == t || 2 == t ? 0 : e.r;
      r && r.call(this.client, n, s, i, o),
        0 == e.r
          ? a.fireObjectChangeEvent(
              ObjectType.CONVERSATION,
              [o],
              ChangeType.INSERT
            )
  ...
  (StringeeChat.prototype.getLastConversations = function (e, t, r) {
    if (e <= 0)
      return void r.call(this.client, !1, -2, "Params are invalid.", null);
    if (!this.client.hasConnected)
      return void r.call(
        this.client,
        !1,
    ...
    this.client._sendMessage(
      StringeeServiceType.CHAT_CONVERSATION_LOAD,
      n,
      function (e) {
        if (r) {
          var n = e.r,
            ...
            null != s &&
              (s = t
                ? s.reverse().map(function (e) {
                    return new StringeeConversation(e, 1);
                  })
                : s.map(function (e) {
                    return new StringeeConversation(e, 1);
                  })),
            void r.call(this.client, i, a, o, s)
          );
        }
      }
    );
  }),
  (StringeeChat.prototype.getConversationsAfter = function (e, t, r, n) {
    if (t <= 0 || e <= 0)
      return void n.call(this.client, !1, -2, "Params are invalid.", null);
    if (!this.client.hasConnected)
      return void n.call(
        this.client,
        !1,
      ...
      function (e) {
        if (n) {
          ...
          return (
            ...
            void n.call(this.client, i, a, o, s)
          );
        }
      }
    );
  }),
  (StringeeChat.prototype.getConversationsBefore = function (e, t, r, n) {
    if (t <= 0 || e <= 0)
      return void n.call(this.client, !1, -2, "Params are invalid.", null);
    if (!this.client.hasConnected)
      return void n.call(
  ...
  (StringeeChat.prototype.getConversationById = function (e, t) {
    if (!e)
      return void t.call(
        this.client,
        !1,
    ...
    this.client._sendMessage(
      StringeeServiceType.CHAT_GET_CONVERSATIONS_INFO,
      r,
      function (e) {
        if (t) {
          var r,
          ...
          return (
            null != s &&
              s.length > 0 &&
              (r = new StringeeConversation(s[0], 1)),
            void t.call(this.client, i, a, o, r)
          );
        }
      }
    );
  }),
  (StringeeChat.prototype.deleteConversation = function (e, t) {
    if (!e)
      return void t.call(this.client, !1, -2, "Conversaion's Id is invalid");
    if (!this.client.hasConnected)
      return void t.call(
        this.client,
        !1,
    ...
    this.client._sendMessage(
      ...
      function (a) {
        if (t) {
              ...
              function (e) {
                var t = e.r,
                  ...
                  c = a
                    ...
                    ? e.message
                    : "Generic error.";
                if ((n.call(r, a, o, c), 0 == e.r)) {
                  var d = new StringeeConversation(s, 1);
                  i.fireObjectChangeEvent(
                    ObjectType.CONVERSATION,
                    [d],
                    ChangeType.DELETE
                  );
          ...
          } else t.call(r, !1, -3, "Can not get conversation's info");
        }
      }
    );
  }),
  // StringeeChat.prototype.updateConversation = function (e, t, r) {
  //     if (!e)
  //         return void r.call(this.client, !1, -2, "Conversation's Id is invalid");
  //     if (!this.client.hasConnected)
  //         return void r.call(this.client, !1, -1, "StringeeClient is not connected to Stringee server.");
  //     var n = {
  //         convId: e,
  //         groupName: t.name,
  //         imageUrl: t.avatar
  ...
  //         , i = this
  //         , a = this.client;
  //     this.client._sendMessage(StringeeServiceType.CHAT_UPDATE_CONVERSATION, n, function (t) {
  //         if (r) {
  //             var n = t.r
  //                 , o = 0 == n
  //                 , s = t.r
  //                 , c = o ? "Success" : null != t.message && t.message.length > 0 ? t.message : "Generic error.";
  //             r.call(this.client, o, s, c)
  //         }
  //         if (0 == t.r) {
  //             var d = {
  //                 convIds: e
  //             };
  //             a._sendMessage(StringeeServiceType.CHAT_GET_CONVERSATIONS_INFO, d, function (e) {
  //                 var t = e.listConvs;
  //                 if (null != t && t.length > 0) {
  //                     var r = t[0]
  //                         , n = new StringeeConversation(r, 1);
  //                     i.fireObjectChangeEvent(ObjectType.CONVERSATION, [n], ChangeType.UPDATE)
  //                 }
  //             })
  //         }
  //     })
  ...
  (StringeeChat.prototype.addParticipants = function (e, t, r) {
    if (!e)
      return void r.call(this.client, !1, -2, "Params are invalid.", null);
    if (!t || !t.length)
      return void r.call(this.client, !1, -2, "Params are invalid.", null);
        ...
        if (0 == t.r) {
          ...
          i._sendMessage(
            ...
            function (e) {
              ...
              if (null != t && t.length > 0) {
                var r = t[0],
                  i = new StringeeConversation(r, 1);
  ...
  (StringeeChat.prototype.removeParticipants = function (e, t, r) {
    if (!e)
      return void r.call(this.client, !1, -2, "Params are invalid.", null);
    if (!t || !t.length)
      return void r.call(this.client, !1, -2, "Params are invalid.", null);
  ...
  (StringeeChat.prototype.sendMessage = function (e, t) {
    if (!e.convId)
      return void t.call(this.client, !1, -2, "Conversation's Id is invalid");
    if (!this.client.hasConnected || null == this.client.userId)
      return void t.call(
        this.client,
        !1,
        -1,
    ...
    var r = this.client.userId,
      n =
        Math.random().toString(36).substring(2, 15) +
        Math.random().toString(36).substring(2, 15),
      i = "web-" + r + "-" + n + "-" + Date.now().toString(),
      a = {
        message: e.message,
        type: e.type,
        convId: e.convId,
      ...
      o = new AutoMessage(i, r, a, t);
    this.msgQueue.push(o);
    var s = new StringeeMessage({}, 3);
    (s.id = null),
      (s.localId = i),
      (s.conversationId = e.convId),
      (s.sender = r),
      (s.createdAt = Date.now()),
      (s.type = e.type),
      (s.content = e.message),
      (s.state = MessageState.INITIALIZE),
      this.trackMsg(s),
      this.fireObjectChangeEvent(ObjectType.MESSAGE, [s], ChangeType.INSERT),
      (s.state = MessageState.SENDING),
      this.fireObjectChangeEvent(ObjectType.MESSAGE, [s], ChangeType.UPDATE);
    var c = this;
    this.client._sendMessage(StringeeServiceType.CHAT_MESSAGE, a, function (n) {
      var a = n.r,
        o = 0 == a,
        s = null;
      if (t && 9 != a) {
        var d = n.r,
          l = o
            ...
            ? n.message
            : "Generic error.";
        (s = new StringeeMessage(n, 2)),
          (s.localId = i),
          (s.type = e.type),
          (s.content = e.message),
          (s.sender = r),
          t.call(this.client, o, d, l, s);
      }
      var p = n.localDbId;
      if (
        (null != p &&
          o &&
          (c.msgQueue = c.msgQueue.filter(function (e) {
            return e.id != p;
          })),
        null != s)
      ) {
        var u = c.keyForMsg(s);
        c.trackingMap.remove(u),
          c.trackingMap.put(u, s),
          c.fireObjectChangeEvent(ObjectType.MESSAGE, [s], ChangeType.UPDATE);
      }
    });
  }),
  (StringeeChat.prototype.sendMessageQueue = function () {
    if (this.msgQueue.length) {
      var e = this.msgQueue[0];
      if (e.userId != this.client.userId && null != this.client.userId)
        return (
          e.callback &&
            e.callback.call(this.client, !1, -3, "Generic error.", null),
          void this.msgQueue.shift()
        );
      var t = this;
      this.client._sendMessage(
        ...
        function (r) {
          var n = r.r,
            ...
            o = i
              ? "Success"
              : null != r.message && r.message.length > 0
              ? r.message
              : "Generic error.",
            s = r.localDbId,
            c = null;
          if (
            (i &&
              ((c = new StringeeMessage(r, 2)),
              (c.localId = s),
              (c.type = e.body.type),
              (c.content = e.body.message),
              (c.sender = e.userId)),
            e.callback && 9 != n && e.callback.call(this.client, i, a, o, c),
            null != s &&
              i &&
              ((t.msgQueue = t.msgQueue.filter(function (e) {
                return e.id != s;
              })),
              t.sendMessageQueue()),
            null != c)
            ...
            var d = t.keyForMsg(c);
            t.trackingMap.remove(d),
              t.trackingMap.put(d, c),
              t.fireObjectChangeEvent(
                ObjectType.MESSAGE,
                [c],
                ChangeType.UPDATE
  ...
  (StringeeChat.prototype.loadChatMessages = function (e, t) {
    var r = {
    ...
    this.client._sendMessage(
      ...
      r,
      function (e) {
        if (t) return void t.call(this.client, e);
      }
    );
  }),
  (StringeeChat.prototype.getLastMessages = function (e, t, r, n) {
    if (!e || t < 0)
      return void n.call(this.client, !1, -2, "Params are invalid.", null);
    if (!this.client.hasConnected)
      return void n.call(
          ...
          if (null != l) {
            ...
            o._sendMessage(
              ...
              function (e) {
                ...
                if (null != t && t.length > 0) {
                  var p = t[0];
                  (i = p.lastMsgSeqReceived), (o = p.lastMsgSeqSeen);
                }
                (l = r
                  ? l.reverse().map(function (e) {
                      var t = new StringeeMessage(e, 0, i, o);
  ...
  (StringeeChat.prototype.getMessagesAfter = function (e, t, r, n, i) {
    if (!e || t < 0 || r < 0)
      return void i.call(this.client, !1, -2, "Params are invalid.", null);
    if (!this.client.hasConnected)
      return void i.call(
        this.client,
        !1,
          ...
          if (null != l) {
            ...
            c._sendMessage(
              ...
              function (e) {
                ...
                if (null != t && t.length > 0) {
                  var p = t[0];
                  (r = p.lastMsgSeqReceived), (c = p.lastMsgSeqSeen);
                }
                (l = n
                  ? l.map(function (e) {
                      var t = new StringeeMessage(e, 0, r, c);
                      return d.trackMsg(t), t;
                    })
                  : l.reverse().map(function (e) {
                      var t = new StringeeMessage(e, 0, r, c);
                      return d.trackMsg(t), t;
                    })),
                  i.call(this.client, a, o, s, l);
              }
            );
          }
        } else;
  ...
  (StringeeChat.prototype.getMessagesBefore = function (e, t, r, n, i) {
    if (!e || t < 0 || r < 0)
      return void i.call(this.client, !1, -2, "Params are invalid.", null);
    if (!this.client.hasConnected)
      return void i.call(
          ...
          if (null != l) {
            ...
            s._sendMessage(
              ...
              function (e) {
                ...
                if (null != t && t.length > 0) {
                  var p = t[0];
                  (r = p.lastMsgSeqReceived), (s = p.lastMsgSeqSeen);
                }
                (l = n
                  ? l.reverse().map(function (e) {
                      var t = new StringeeMessage(e, 0, r, s);
                      return c.trackMsg(t), t;
                    })
                  : l.map(function (e) {
                      var t = new StringeeMessage(e, 0, r, s);
                      return c.trackMsg(t), t;
                    })),
                  i.call(this.client, a, o, d, l);
              }
            );
          }
        } else;
  ...
  (StringeeChat.prototype.deleteMessage = function (e, t, r) {
    if (!e) return void r.call(this.client, !1, -2, "Params are invalid.");
    if (!t) return void r.call(this.client, !1, -2, "Params are invalid.");
    if (!this.client.hasConnected)
      return void r.call(
        this.client,
        !1,
    ...
    this.client._sendMessage(
      StringeeServiceType.CHAT_GET_MESSAGES_INFO,
      a,
      function (a) {
        if (0 == a.r) {
          var o = a.listMsgs;
        ...
        } else r.call(this.client, !1, -3, "Message is not found.");
      }
    );
  }),
  (StringeeChat.prototype.clearHistory = function (e, t) {
    if (!e.convId)
      return void t.call(this.client, !1, -2, "Params are invalid.");
    if (!this.client.hasConnected)
      return void t.call(
        this.client,
        !1,
      ...
      function (e) {
        if (t) {
          var r = e.r,
            n = 0 == r,
            i = n ? "Success" : "Fail";
          return void t.call(this.client, n, r, i);
        }
      }
    );
  }),
  (StringeeChat.prototype.userBeginTyping = function (info, callback) {
    var body = { userId: info.userId, convId: info.convId };
    this.client._sendMessage(
  ...
  (StringeeChat.prototype.userEndTyping = function (info, callback) {
    var body = { userId: info.userId, convId: info.convId };
    this.client._sendMessage(
  ...
  (StringeeChat.prototype.markMessageSeen = function (e, t) {
    if (!e.conversationId)
      return void t.call(this.client, !1, -2, "Params are invalid.");
    if (!this.client.hasConnected)
      return void t.call(
      ...
      function (e) {
        if (t) {
          var r = e.r,
            n = 0 == r,
            i = n ? 0 : -3,
            a = n ? "Success" : "Generic error.";
          return void t.call(this.client, n, i, a);
        }
      }
    );
  }),
  (StringeeChat.prototype.markConversationAsRead = function (e, t) {
    if (!e)
      return void t.call(this.client, !1, -2, "Conversation's Id is invalid");
    if (!this.client.hasConnected)
      return void t.call(
    ...
    this.client._sendMessage(
      ...
      function (a) {
        ...
        if (null != o && o.length > 0) {
          ...
          r._sendMessage(StringeeServiceType.CHAT_MESSAGE_REPORT, l, function (
            t
          ) {
            if (n) {
              var a = t.r,
                o = 0 == a,
                s = o ? 0 : -4,
                c = o ? "Success" : "Generic error.";
              n.call(r, o, s, c);
            }
            if (0 == t.r) {
              var d = i.trackingMap.allValues(),
                l = [];
              d.forEach(function (t) {
                if (t.conversationId == e) {
                  (t.state = MessageState.READ), l.push(t);
                  var r = i.keyForMsg(t);
                  i.trackingMap.remove(r);
                }
              }),
                l.length > 0 &&
                  i.fireObjectChangeEvent(
                ...
                i.getConversationById(e, function (e, t, r, n) {
                  e &&
                    null != n &&
                    i.fireObjectChangeEvent(
                      ObjectType.CONVERSATION,
        ...
        } else t && t.call(r, !1, -3, "Can not get conversation's info");
      }
    );
  }),
  (StringeeChat.prototype.getUnreadConversationCount = function (e) {
    if (!this.client.hasConnected)
      return void e.call(
        this.client,
        !1,
    ...
    var t = {};
    this.client._sendMessage(
      StringeeServiceType.CHAT_UNREAD_CONVERSATION_COUNT,
      t,
      function (t) {
        if (e) {
          var r = t.r,
            ...
            a = n ? "Success" : "Generic error.",
            o = t.count;
          e.call(this.client, n, i, a, o);
        }
      }
    );
  }),
  (StringeeChat.prototype.unreadConversationCount = function (callback) {
    var body = {};
    this.client._sendMessage(
      StringeeServiceType.CHAT_UNREAD_CONVERSATION_COUNT,
      body,
  ...
  (StringeeChat.prototype.getConversationWithUser = function (e, t) {
    if (!e) return void t.call(this.client, !1, -2, "UserId is invalid");
    if (!this.client.userId || !this.client.hasConnected)
      return void t.call(
        this.client,
        !1,
        -1,
    ...
    var r = {
      participants: [e, this.client.userId],
    };
    this.client._sendMessage(
      StringeeServiceType.CHAT_CONVERSATION_FOR_USERS,
      r,
      function (e) {
        if (t) {
          var r,
            ...
            i = 0 == n,
            a = i ? 0 : -3,
            o = i ? "Success" : "Generic error.",
            s = e.conversations;
          if (s.length > 0) {
            (r = new StringeeConversation(s[0], 1)),
              t.call(this.client, i, a, o, r);
          } else t.call(this.client, !1, -4, "Conversation is not found.", r);
        }
      }
    );
  }),
  (StringeeChat.prototype.blockUser = function (e, t) {
    if (!e) return void t.call(this.client, !1, -1, "UserId is invalid");
    var r = {
      userId: e,
    };
    this.client._sendMessage(StringeeServiceType.CHAT_BLOCK_USER, r, function (
      e
    ) {
      if (t) {
        var r = e.r,
  ...
  (StringeeChat.prototype.blockInviteToGroup = function (e, t) {
    if (!e)
      return void t.call(this.client, !1, -1, "Conversation's Id is invalid");
    var r = {
  ...
  (StringeeChat.prototype.rateChat = function (e, t, r, n) {
    var i = {
      convId: e,
      rating: t,
      comment: r,
    };
    this.client._sendMessage(StringeeServiceType.RATE_CHAT, i, function (e) {
      if (n) return void n.call(this.client, e);
    });
  }),
  (StringeeChat.prototype.updateUserInfo = function (e, t, r, n) {
    var i = {
      display_name: e,
      avatar_url: t,
      email: r,
    };
    this.client._sendMessage(StringeeServiceType.UPDATE_USER_INFO, i, function (
      e
    ) {
      if (n) return void n.call(this.client, e);
    });
  }),
  (StringeeChat.prototype.updateUserInfo = function (body, callback) {
    this.client._sendMessage(
      StringeeServiceType.UPDATE_USER_INFO,
      body,
      function (res) {
        if (callback) {
          callback.call(this.client, res);
  ...
  (StringeeChat.prototype.getUsersInfo = function (e, t) {
    if (!e || !e.length)
      return void t.call(this.client, !1, -2, "UserIds are invalid.", null);
    if (!this.client.userId || !this.client.hasConnected)
      return void t.call(
        this.client,
        !1,
    ...
    this.client._sendMessage(
      StringeeServiceType.CHAT_GET_USERS_INFO,
      n,
      function (e) {
        if (t) {
          var r = e.r,
          ...
          return (
            ...
            void t.call(this.client, n, r, i, o)
          );
        }
      }
    );
  }),
  (StringeeChat.prototype.sendEmailTranscript = function (e, t) {
    var r = {
      convId: e.convId,
      email: e.email,
      domain: e.domain,
  ...
  (StringeeChat.prototype.getChatServices = function (e) {
    var t = {};
    this.client._sendMessage(
      StringeeServiceType.GET_CHAT_SERVICES,
      t,
      function (t) {
        if (e) return void e.call(this.client, t);
      }
    );
  }),
  (StringeeChat.prototype.viewChat = function (e, t) {
    var r = {
      convId: e,
    };
    this.client._sendMessage(StringeeServiceType.VIEW_CHAT, r, function (e) {
      if (t) return void t.call(this.client, e);
    });
  }),
  (StringeeChat.prototype.joinChat = function (e, t) {
    var r = {
      convId: e,
    };
    this.client._sendMessage(
      StringeeServiceType.JOIN_CHAT_CUSTOMER_CARE,
      r,
      function (e) {
        if (t) return void t.call(this.client, e);
      }
  ...
  (StringeeChat.prototype.transferChat = function (e, t, r) {
    var n = {
      convId: e,
    ...
    this.client._sendMessage(
      ...
      n,
      function (e) {
        if (r) return void r.call(this.client, e);
      }
    );
  }),
  (StringeeChat.prototype.confirmTransferChat = function (e, t) {
    var r = {
      convId: e,
      answer: 1,
    };
    this.client._sendMessage(
      StringeeServiceType.CHAT_CONFIRM_TRANSFER_REQUEST,
      r,
      function (e) {
        if (t) return void t.call(this.client, e);
      }
...
(StringeeChatProcessor._routeChatToAgent = function (e, t) {
  console.log("_routeChatToAgent: " + JSON.stringify(t)),
    e._callOnEvent("incommingchat", t);
}),
  (StringeeChatProcessor._userBeginTypingListener = function (e, t) {
    // console.log('_userBeginTypingListener: ' + JSON.stringify(body));
    e._callOnEvent("userBeginTypingListener", t);
  }),
  (StringeeChatProcessor._userEndTypingListener = function (e, t) {
    // console.log('_userEndTypingListener: ' + JSON.stringify(body));
    e._callOnEvent("userEndTypingListener", t);
  }),
  (StringeeChatProcessor._updateUserInfoMsg = function (client, body) {
    console.log("_updateUserInfoMsg: " + JSON.stringify(body));
    client._callOnEvent("updateUserInfoMsg", body);
  }),
  (StringeeChat.prototype.on = function (e, t) {
    this._onMethods.put(e, t);
  }),
  (StringeeChat.prototype._callOnEvent = function (e, t) {
    var r = this._onMethods.get(e);
    r
      ? t
        ? r.call(this, t)
  ...
  (StringeeChat.prototype.fireObjectChangeEvent = function (e, t, r) {
    this._callOnEvent(realTimeEvent, {
      objectType: e,
      objectChanges: t,
      changeType: r,
    });
  }),
  (StringeeChat.prototype.trackMsg = function (e) {
    if (e.state != MessageState.READ) {
      var t = this.keyForMsg(e);
      this.trackingMap.put(t, e);
    }
  }),
  (StringeeChat.prototype.keyForMsg = function (e) {
    var t =
        null != e.conversationId && e.conversationId.length > 0
          ? e.conversationId
          : "",
      r = null != e.id && e.id.length > 0 ? e.id : "",
      n = null != e.localId && e.localId.length > 0 ? e.localId : "";
    return t + "_" + (n.length > 0 ? n : r);
  });
